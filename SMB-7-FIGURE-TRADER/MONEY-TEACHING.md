...
After each trade, review what happened and score each of the 10 variables. Most traders reviewing their trades focus only on what went wrong, but to build a profitable trading business a trader must identify what was done well. Ask: what was the catalyst? Why was this a great trade? What did I do to find it? Then find more trades like that. The traders received a 9 on diligence for reading the income statement, a 9 on stock selection for finding the negative news catalyst, a 7.5 on trade review for identifying the catalyst and what was done well, an 8.5 on trade management for the opening range break execution, and a 0 on reading the tape because they omitted that variable. Their total score was 76.2, below the 80 threshold, because they failed to include the tape. The feedback was used to identify what to repeat, not just what to fix.

### Step 11: Compile Playbook Trades and Identify Your Best Setups

Over weeks and months, compile the daily playbook trades (the one best trade identified per day in Step 2) into a personal database. Review this database to identify the setups you execute most consistently in real time and that generate the highest returns. Repeat those trades. Eliminate the trades you do not do well with. This is how you build your trading business - by reviewing and analyzing your playbook trades and focusing on your edge. If a trade is not already in your playbook, you should not be making it during market hours. If you are making trades outside your playbook, you are overtrading.
...
- ✅ Focus trade reviews on what you did well and find more trades like that
...
- ❌ Do not ignore declining operating margins in earnings reports
- ❌ Do not enter a trade without knowing exactly why you are in it and how you will trade it
...
- **Problem:** Making trades during market hours that are not already in your playbook
  **Solution:** Strictly enforce a rule that you only trade setups documented in your playbook. Any trade outside it is overtrading and should be avoided.

- **Problem:** Having a setup but not a specific trade with defined entry, exit, and risk parameters
  **Solution:** For every scenario in your trade plan, define exactly what "fails" means and allocate proper risk. Do not enter a trade without knowing your stop and target.

- **Problem:** Only focusing on mistakes and shortcomings during trade reviews
   **Solution:** Force yourself to identify what you did well, why it was a great trade, and what you can repeat. Find more trades like your best ones instead of nitpicking every flaw.

- **Problem:** Ignoring income statement fundamentals when analyzing earnings reports
...
- **Problem:** Trading low-liquidity stocks without adjusting risk allocation
   **Solution:** Grade liquidity as part of a trader's risk allocation. Lower liquidity means smaller position size - for example, 50 shares instead of full size - and expect wider spreads and more slippage on volatile moves. Scale into positions gradually rather than entering full size at once.
