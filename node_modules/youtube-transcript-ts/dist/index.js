...
var YouTubeTranscriptApi = class _YouTubeTranscriptApi {
  ...
  static isBlockedHost(hostname) {
    ...
    if (net.isIP(ipLiteral) === 6 && (ipLiteral.startsWith("fc") || ipLiteral.startsWith("fd") || ipLiteral.startsWith("fe80"))) {
      return true;
    }
    return false;
  }
