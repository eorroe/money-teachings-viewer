...
- When you need to trade earnings reports as swing trades entered on day one (the first trading session following the report) and held for two weeks to two months
- When screening and selecting which earnings reports to focus on each morning
- When trying to determine whether an earnings gap up will sustain through the first trading session and into the second day, or will sell off
- When you want to understand how Wall Street will re-rate a stock based on its earnings history
- When looking for leading indicators within a sector to predict future earnings reactions

## Steps

### Step 1: Understand the Four Earnings Report Buckets
...
Use three main screening methods to narrow down which reports to review before the market opens:

- Percent Above Average Volume (Percent A vol): Look at the volume a stock does in the overnight session compared to its average daily volume. Percent Above Average Volume (Percent A vol) above 50% signals reports with overnight volume exceeding 50% of average daily volume.
- Average True Range (ATR) gap or percent gap versus implied move: Assess the magnitude of the gap relative to the expected price move derived from options pricing (implied move). Gaps that exceed the implied move by at least 10% signal results that exceeded the implied move by at least 10%.
- Hot themes: Maintain a list of market themes where constituent stocks are showing follow-through with upward price movement (e.g., fiber optics, photonics, AI infrastructure) and know when stocks in those themes are scheduled to report.

### Step 3: Grade the Trade Before the Open

Before the market opens, evaluate each candidate using these factors:

- Theme: Is the stock part of a hot theme where constituent stocks are showing follow-through with upward price movement?
  - Higher timeframe technicals: Is the stock breaking out to new 3-month or 6-month highs, or running into overhead resistance (a prior price high where historical sell orders have previously capped the stock's advance)? Does the gap up exceed the prior 3-month or 6-month high on volume, confirming a technical breakout?
- Overnight price action: Is the after-hours range holding above the initial reaction level? Is the premarket range holding above its opening level as well?
- Volume confirmation: You need to see volume bars at least 2 standard deviations above the 20-day average daily volume off the open to indicate elevated trading volume.

### Step 4: Execute the Day-One Trade

If the premarket high holds above the opening price into the open and volume confirms the move, enter the trade:

- Buy above the premarket high once volume reaches at least 2 standard deviations above the 20-day average daily volume.
- Add on dips of 2% to 3% below the entry price during the opening-drive phase (the first 5 to 15 minutes of the trading session), especially if the stock shows higher highs and higher lows into the open.
- Recognize the highest-momentum phase is the initial opening price move (the first 5 to 15 minutes of the trading session). Have an exit plan ready to manage the trade during this phase.
- For a swing trade, hold for two weeks to two months if the trade thesis remains valid (the stock holds above its day-one closing price and the theme follows through with upward price movement) and the stock continues to hold above its day-one closing price.

### Step 5: Use Early Theme Reporters as a Leading Indicator

For the fourth bucket specifically:
...
### Example 1: Fiber Optics/Photonics Theme (Q1 Earnings Season)
...
- AAOI reported third with a record revenue quarter and near profitability (projected to turn profitable within the next quarter), 14.5% short interest, a float of 60-70 million shares, and a weekly/monthly chart breaking above the resistance level established in 2017. It was a stock with a history of single-day price moves of at least 10% following earnings reports within the theme. Day one saw a gap above the prior close, high volume off the open, and nearly doubled in the first two days.
...
### Example 2: AAOI as a Theme Play Exception

AAOI did not cleanly fit the existing three buckets because it was not yet profitable and did not show classic acceleration in revenue growth. However, because it was in a hot theme showing follow-through with upward price movement, had 14.5% short interest, a float of 60-70 million shares, a history of single-day price moves of at least 10% following earnings reports, and a technical breakout above the resistance level established in 2017, traders made an exception and treated it as a fourth-bucket hot-theme play. The stock gained on day one and continued moving higher after day one.

## Best Practices

- ✅ Categorize every earnings report into one of the four buckets to standardize decision-making.
- ✅ Look at earnings in the context of prior earnings history, not in isolation.
- ✅ For the first three buckets, only consider stocks that are already profitable; for the fourth bucket, an unprofitable stock may qualify if it is projected to be profitable within one quarter and reports within a theme showing follow-through with upward price movement.
- ✅ Use early reporters in a theme as a leading indicator for later reporters.
- ✅ Confirm premarket and after-hours price action holds above the premarket high before entering.
- ✅ Wait for volume bars at least 2 standard deviations above average off the open before committing.
- ✅ Maintain theme lists and earnings calendars so you know when key names report.
- ✅ Look for higher highs and higher lows into the open as confirmation of clean momentum.
- ✅ Do not short stocks in a hot theme showing follow-through with upward price movement.
...
- Trading earnings involves risk of loss. This teaching is for educational purposes only and is not financial advice.
- Use position sizing that limits loss to 1% to 2% of trading capital per trade, and place stop losses at a price level that invalidates the trade thesis. Earnings gaps can reverse quickly. Risk no more than 1% to 2% of capital per trade.
- Verify all earnings data and screens from established financial data providers before trading.
