# SMB Capital - Why Did One Trader Make $200 and Another $2000 on the Same Setup
...
- When you catch yourself wanting to sell at the highest price of the move or sell into strength too early
...
Do not enter until you see a real, verifiable shift in price action. Watch the tape develop. Wait for buyers to step in, volume to accelerate, and the character of the price action to change. Calculate your stop placement before entry. Place your stop below the low of the pullback candle. Enter at or near the highs of that candle. This is a calculated decision, not an impulsive one. Both Steve and Paula entered at the same price with the same initial risk. The difference came after entry.

### Step 3: Immediately After Entry, Stop Talking to Yourself About P&L

The moment you enter, do not start running P&L calculations in your head. That voice saying "I just want to make $200" is distracting you from the stock. Nobody on the other side of the trade cares about your target. No one is monitoring your trade to help you hit your target. When you focus on your P&L, you miss the information the tape is giving you: increasing volume, continuous buying, accelerating momentum. Steve exited right into the top because he was focused on his P&L. Paula stayed in because she was focused on the stock.
...
Paula saw the exact same setup. She entered at the same price with the same initial risk. The difference is what she did next. She did not focus on her P&L. She focused on the tape. She watched the buyers step in after the VWAP reclaim. She saw volume accelerate. She watched the 9 EMA curl up. She recognized that this was no longer just a VWAP continuation trade. The entire stock was shifting. She added to her position and moved her stop up. She watched for the next trading opportunity. She stayed in until the 9 EMA broke. She walked away with $2,000 on the same trade Steve took $200 from. Same setup. Same chart. Different outcome.
...
- ✅ Wait for a distinct and noticeable change in the tape before entering. Patience improves your results.
- ✅ When a confirmed momentum trade shifts in your favor, consider adding to the position and moving your stop up.
...
- **Problem:** You take a quick profit trade and later see the stock continue without you.
   **Solution:** Before exiting, scan the tape one more time. Check volume, continuous buying, and the 9 EMA. If the tape is confirming momentum, do not exit just because you hit a round profit target.

- **Problem:** You sell into strength because it feels good to take a win and you are afraid of giving it back.
  **Solution:** Understand that in confirmed momentum, selling into strength can be more risky than staying in. Let your predefined exit rule (e.g., close below 9 EMA) trigger the exit, not the desire to lock in profits.

- **Problem:** You sell at the highest price of the move by trying to sell at the highest price reached of the move.
  **Solution:** Stop trying to predict the top. Selling at the highest price is unpredictable. A predefined exit rule gives you reliable results.

- **Problem:** You stop watching the tape after a winning trade and miss the next trading opportunity that forms in the same stock.
