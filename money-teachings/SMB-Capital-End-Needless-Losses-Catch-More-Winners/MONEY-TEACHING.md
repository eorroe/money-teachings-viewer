...
Only mark A+ pink lines drawn from the daily or weekly chart. A level tested at least three times on volume at or above 150% of the 20-day average daily volume and repelling the stock each time is an A+ level. Each test builds institutional participation: short sellers who need to cover and long traders who were previously stopped out and want to re-enter. Levels with fewer than two confirmed high-volume tests should not be treated as high-probability breakout targets. A pink line drawn from a 5-minute or lower intraday chart is not a valid A+ level.
...
- **Catalyst**: A catalyst that results in a price target revision of at least 20% from the most recent consensus analyst price target published prior to the catalyst event, such as an FDA approval, earnings pre-announcement, major contract win, or regulatory filing. You must be able to explain the catalyst's expected price impact in one sentence and see volume at or above 200% of the 20-day average daily volume (this is the standalone threshold for catalyst entries, superseding the 150% baseline) before entering.
- **Compression**: The stock has been tightly consolidating in a range no wider than 0.25x its 20-day ATR (ATR = Average True Range, a volatility measure calculated as (Close - PrevClose) / ATR, accumulated; 0.25x ATR represents the dollar distance of the range) for at least three consecutive daily candles, creating a volatility contraction where the range narrows progressively (each successive daily candle has a range at least 10% narrower than the prior candle's range). Breaking out of this compressed range can foreshadow the full pink line breakout.
...
- **In-Play Intraday Exception**: For stocks with volume at or above 300% of the 20-day average daily volume and an active catalyst (a catalyst event announced within the 24 hours ending at the current regular-session close), an intraday level with at least two tests on high volume during the current regular trading session (9:30 AM–4:00 PM ET) can qualify as an A+ pink line. This is an outlier scenario reserved for these specific conditions, not the norm.

### Step 7: Trade at the Edges of Ranges, Not the Middle

When a stock is in a defined trading range (bounded by a clear support low and resistance high, each tested and confirmed, spanning at least 10 daily candles), avoid entering trades in the middle third of the price range, calculated as the zone between the support low plus one-third of the range and the support low plus two-thirds of the range. Whether fading a rejection or buying a breakout, there is a risk-reward ratio of at least 2:1 at the range extremes — the support low and the resistance/pink line high. A defined trading range is a price channel bounded by a clear support low and resistance high, each tested and confirmed, spanning at least 10 daily candles. Middle-of-range price action is unpredictable with no confirmed directional bias, driven by unpredictable order flow, and leads to overtrading as traders try to guess direction without any confirmed edge.
...
The broader market internals are bullish (NYSE TICK (the difference between advancing and declining NYSE-listed stocks on upticks minus those on downticks) above +500, advance/decline ratio above 2:1), and a stock is pressing against its pink line at 10:05 AM ET after running one full 20-day ATR from its opening price. The setup looks like an extreme bullish intraday breakout setup. However, at 3:55 PM ET, the stock closes at 195.30 — 0.20 points below the pink line at 195.50. By waiting and not entering the trade, the trader avoids a loss. The win is the discipline to not take a trade that failed to confirm by the close.

### Example 3: SMCI Pre-Announcement Breakout

SMCI (Super Micro Computer) pre-announces earnings with a specific revenue guidance figure that exceeds Wall Street consensus by at least 15%, and the stock is trading 4% below its pink line in the pre-market session at 4:30 AM ET. The catalyst is material, the volume is running at 250% of the 20-day average, and the stock is not gapping up in the regular session open — all conditions of the catalyst exception are documented before entry. The stock closes above the pink line that day at 3:55 PM ET, moving an additional 8 points over the next three sessions, illustrating the catalyst exception applied correctly.
...
- The pink line rule is a full trading process, not just a line drawn on a chart. The methodology — including energy measurement, time-of-day restrictions, and exception criteria — must be practiced and internalized until it becomes automatic.
...
- Waiting for the close above the pink line is never a missed opportunity. All sustained, significant price movement above a confirmed breakout level is where the real profit is made; entries below the line only expose you to fakeout risk.
...
- Always use a stop-loss order at or below the pink line (for long entries) and proper position sizing (no more than 1-2% of total trading capital on any single trade) when implementing this methodology.
- Past performance of any trading rule or methodology — including this one — does not guarantee future results.
- This methodology is intended for traders with a minimum of 6 months of live trading experience and an established risk management framework.
