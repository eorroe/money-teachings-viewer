...
- SMB estimated QURE's market cap at $3-4 billion post-gap, while their revenue scenarios suggested much higher potential, indicating the stock was likely undervalued
...
Use a TWAP (Time-Weighted Average Price) program to accumulate shares as the stock holds above your desired level. For QURE, traders set the TWAP to buy every 30 seconds as long as price stayed above the pullback low and consolidation range. This smooths entry price and builds size without chasing.
...
Take partial profits into strength, then trail the remainder using trend lines, moving averages, or price action signals. When volume dries up and the stock struggles to push higher, tighten the stop and exit. For QURE, traders sold some at the highs around $50 and trailed the rest until the bounce weakened.
...
ABBVX gapped up over 500% in mid-July after being added to a medical conference. Like QURE, it held its gap day one, consolidated, then trended for about a month afterward. This analog gave SMB traders additional conviction that QURE could follow a similar path, reinforcing the watch and the long bias.
...
- Always verify the catalyst is real and public before trading
- Be aware of offering risk when holding biotech or small-cap names overnight
- Confirm the stock has adequate liquidity for your position size
- Use stops to limit downside on any single trade
- Do not rely solely on social media sentiment or single sources for catalyst validation
